...
namespace MachinaTrader.Exchanges
{
    public class ExchangeSimulationApi : ExchangeAPI
    {
        ...
        protected override async Task<IEnumerable<KeyValuePair<string, ExchangeTicker>>> OnGetTickersAsync()
        {
            ...
            {
                //listOfMakert.Add(this.ExchangeSymbolToGlobalSymbol(item.MarketSymbol));
        ...
        protected override async Task<IEnumerable<MarketCandle>> OnGetCandlesAsync(string symbol, int periodSeconds, DateTime? startDate = null, DateTime? endDate = null, int? limit = null)
        {
            ...
            foreach (var item in items)
            {
                try
                {
                    ...
                    marketCandle.QuoteCurrencyVolume = (item.Volume * item.Close).ConvertInvariant<double>();
        ...
        {
            var markets = Global.AppCache.GetOrAdd(_realApi.Name, async (a) => await _realApi.GetMarketSymbolsMetadataAsync());
        ...
        protected override async Task<IEnumerable<string>> OnGetMarketSymbolsAsync() // OnGetSymbolsAsync()
        {
