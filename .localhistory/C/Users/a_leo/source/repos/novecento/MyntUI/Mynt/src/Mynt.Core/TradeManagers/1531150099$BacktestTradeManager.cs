...
namespace Mynt.Core.TradeManagers
{
    public class BacktestTradeManager : ITradeManager
    {
        ...
        public BacktestTradeManager(IExchangeApi api, ITradingStrategy strategy, INotificationManager notificationManager, ILogger logger, TradeOptions settings, IDataStore dataStore)
        {
            _api = api;
            _strategy = strategy;
            _logger = logger;
