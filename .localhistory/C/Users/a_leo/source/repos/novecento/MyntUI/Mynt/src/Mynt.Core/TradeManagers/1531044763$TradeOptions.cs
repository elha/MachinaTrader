...
namespace Mynt.Core.TradeManagers
{
    ...
    {
        decimal stopLossPercentage = -0.08m;

        // Trader settings
        public int MaxNumberOfConcurrentTrades { get; set; } = 10;
        public decimal AmountToInvestPerTrader { get; set; } = 150m;
        ...
        public decimal ImmediatelyPlaceSellOrderAtProfit { get; set; } = 0.20m;
        ...
        public int MinimumAmountOfVolume { get; set; } = 200;

        // Default strategy to use with trade managers.
        public string DefaultStrategy { get; set; } = nameof(FreqTrade);
        ...
        public bool PaperTrade { get; set; }
    }
}
